...
export function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="relative hidden h-dvh shrink-0 flex-col overflow-hidden border-r border-sidebar-border bg-sidebar lg:flex"
      style={{
    ...
    >
      ...
      <div className="relative flex h-16 items-center gap-3 px-4">
        ...
        <button
          ...
          className={cn(
            'absolute -right-3 top-5 z-10 flex size-6 items-center justify-center rounded-full border border-border bg-card shadow-sm text-muted-foreground transition-colors hover:text-foreground',
            !sidebarOpen && 'right-auto left-full ml-2',
          )}
        >
                ...
                <>
                  ...
                  <item.icon
                    className={cn(
                      ...
                      isActive ? 'text-primary' : 'text-sidebar-foreground/60 group-hover:text-foreground',
                    )}
                  />
                  <AnimatePresence>
                    {sidebarOpen && (
